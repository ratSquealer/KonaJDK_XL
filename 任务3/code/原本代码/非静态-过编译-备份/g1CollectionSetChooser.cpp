...
G1AdaptiveParameterControl G1CollectionSetChooser::adaptive_mixedgc(G1MixedGCLiveThresholdPercent, G1HeapWastePercent, G1MixedGCCountTarget, G1OldCSetRegionThresholdPercent);
